...
## Interpretation
Value range: [0,21], lower is better
...
## Interpretation
Value range: [0,36], lower is better
...
- discovery-server:
    ...
    - \[http put\]: 0
    - \[http delete\]: 0
    - \[security filterchain before\]: 0
    - \[secured request\]: 0
    - \[security filterchain after\]: 0
    - \[http post\]: 0

- book-service:
    - \[graphql field create-book\]: 0
    - \[graphql -delete-book\]: 0
    - \[graphql field get-all-books\]: 0
    - \[graphql field delete-book\]: 0
    - \[graphql -get-books\]: 0
    - \[graphql -create-book\]: 0
    - \[http post /api/graphql\]: 0
...
- stock-check-service:
    - \[http get /actuator/prometheus\]: 0
    - \[http get /api/stockcheck\]: 0

- order-service:
    - \[stock-check-service-lookup\]: 0
    - \[message-topic\]: 0
    - \[http get /actuator/prometheus\]: 0
    - \[http post /api/order\]: 0
...
- author-service:
    - \[http get /api/authors\]: 0
    - \[http post /api/authors\]: 0
    - \[http delete /api/authors/{id}\]: 0
    - \[http get /actuator/prometheus\]: 0
...
- api-gateway (\[http delete\]): \[http delete\]
...
## Interpretation
Value range: [0,12], lower is better
...
## Interpretation
Value range: [0,2344], lower is better
